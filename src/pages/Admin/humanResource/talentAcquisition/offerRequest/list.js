...
import { OFFER_FILTER_OPTIONS, STATUS_FILTER_OPTIONS } from "../../../../../utils/constants";
import DynamicTable from "../../../../../components/tables/AnnouncementsTable";
import DownloadAttachmentsModal from "../../../../../components/common/downloadAttachmentsModal";
import CustomMenu from "../../../../../components/common/CustomMenu";
import { useOfferRequestsList } from "../../../../../utils/hooks/api/useOfferRequests";
...
const OffersList = () => {
  ...
  const { data, loading, totalPages } = useOfferRequestsList({
    page,
    perPage,
    status,
    searchQuery,
  ...
  const handleAddContract = () => {
    navigate("/admin/human-resource/talent-aquisition/offer-request");
  };
