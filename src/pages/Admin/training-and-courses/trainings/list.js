...
const Trainings = () => {
  ...
  const { getTrainingsAndCourses, trainings, loading, refetch, totalPages, count } = useGetTrainingsAndCourses(
    page, 
    searchQuery, 
    filters, 
    perPage, 
  ...
  }, [page, searchQuery, filters, perPage, user?.id])
  ...
  const columns = [
    { key: "course_name", label: "Training Name" },
    { key: "created_at", label: "Created On" },
    { key: "publisher", label: "Publisher" },
    { key: "course_details", label: "Training Details", type: "description", render: row => row?.course_details },
      ...
      <PageWrapperWithHeading 
        ...
        <div className="bg-white p-4 rounded-lg shadow-md flex flex-col gap-4">
            ...
            <div className="flex gap-2">
              ...
              >
                <ListFilter
                  ...
                  courseOptions={trainings.map(training => ({
                    value: training.id,
                    label: training.course_name
                  }))}
                />
              </FiltersWrapper>
            </div>
          ...
          <DynamicTable
            columns={columns}
            data={trainings}
            footerInfo={`Trainings out of ${count}`}
            currentPage={page + 1}
