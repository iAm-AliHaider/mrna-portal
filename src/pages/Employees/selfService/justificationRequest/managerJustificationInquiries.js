...
export default function ManagerJustificationInquiries() {
  ...
  const breadcrumbItems = [
    ...
    const {
      ...
      error,
      count,
    } = useJustificationRequests(page, searchQuery, {}, perPage, "justification", employeeId, true);
  ...
  return (
       <React.Fragment>
    <PageWrapperWithHeading title="Justification Inquiries" items={breadcrumbItems}>
