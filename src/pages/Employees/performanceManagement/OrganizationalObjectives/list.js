// OrganizationalObjectivesPage.js
...
import {
  useDeleteOrganizationalObjective,
  useOrganizationalObjectivesList
} from '../../../../utils/hooks/api/companyObjectives'

const OrganizationalObjectivesPage = () => {
  ...
  const { objectives, loading, count, totalPages, refetch } =
    useOrganizationalObjectivesList(currentPage - 1, perPage, searchQuery)
          ...
          items={[
            {
              ...
              action: () =>
                navigate(`/performance/org-objectives/edit/${row?.id}`)
            },
            {
              label: 'Delete',
  ...
  const handleAddOjective = () => {
    navigate('/performance/org-objectives/org-obj-new')
  }
...
export default OrganizationalObjectivesPage
