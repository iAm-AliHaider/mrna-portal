...
import LeaveBalancePDF from "../../../../components/pdfComponenets/LeaveBalancePDF";
...
const reportNameOptions = [
  {
    value: "Default Leave Balance Report",
    label: "Default Leave Balance Report",
  },
];
    ...
    <Box className="page-wrapper">
      <Box className="page-header">
        <Typography variant="h5" fontWeight={600}>
          Employee (s) Leave Balance Reports
        </Typography>
      </Box>
